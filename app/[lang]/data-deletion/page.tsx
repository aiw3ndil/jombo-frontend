            ...
            <section className="py-20 px-4 bg-white relative -mt-5">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white border-2 border-[#e2e8f0] rounded-[3rem] p-8 md:p-16 shadow-[0_32px_64px_-16px_rgba(22,101,52,0.1)] relative overflow-hidden">
                        <div className="space-y-16 text-[var(--brand-dark)] leading-relaxed">
                                    ...
                                    <div className="space-y-4 pl-6 border-l-2 border-green-50">
                                        ...
                                        <ul className="space-y-3">
                                            {[
                                                ...
                                                <li key={i} className="flex items-center gap-3 text-base font-medium text-[var(--brand-neutral)]">
                                                    <div className="w-5 h-5 bg-[#e2e8f0] rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <section className="bg-[#f0f4f8] border-2 border-[#e2e8f0] rounded-[3rem] p-8 md:p-12 shadow-inner relative overflow-hidden group">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-[#e2e8f0]/50 rounded-full -mr-16 -mt-16 group-hover:scale-110 transition-transform duration-500"></div>
                                
                                <h2 className="text-3xl font-black text-[var(--brand-dark)] mb-10 flex items-center gap-4 relative z-10">
                                    <div className="w-12 h-12 bg-[var(--brand-blue)] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-green-200">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                                    <div className="space-y-8">
                                        <div className="inline-block bg-white px-4 py-1.5 rounded-full border border-[#e2e8f0] shadow-sm text-xs font-black text-[var(--brand-blue)] uppercase tracking-widest">
                                        ...
                                        <div className="space-y-6">
                                            {[
                                                ...
                                                <div key={i} className="flex gap-6 items-start group/step">
                                                    <span className="flex-shrink-0 w-8 h-8 rounded-xl bg-white border-2 border-[#e2e8f0] flex items-center justify-center text-sm font-black text-[var(--brand-blue)] shadow-sm group-hover/step:border-green-600 group-hover/step:bg-[var(--brand-blue)] group-hover/step:text-white transition-all">
                                                        {i + 1}
                                                    </span>
                                                    <p className="text-lg font-medium text-[var(--brand-dark)] leading-snug group-hover/step:text-[var(--brand-dark)] transition-colors pt-0.5">
                                                        {step}
                                                    </p>
                                                </div>
                                            ))}
                                    ...
                                    <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#e2e8f0] shadow-xl space-y-8">
                                        <div className="inline-block bg-[var(--brand-blue)] px-4 py-1.5 rounded-full text-[10px] font-black text-white uppercase tracking-widest">
                                            {t("dataDeletion.section5.subtitle")}
                                        </div>
                                        <p className="text-lg font-medium text-[var(--brand-neutral)]">
                                            {t("dataDeletion.section5.content")}
                                        </p>
                                        <div className="p-6 bg-[#f0f4f8] rounded-2xl border-2 border-[#e2e8f0] text-center hover:border-[#e2e8f0] transition-colors group/email">
                                            <p className="text-[var(--brand-blue)] font-bold uppercase tracking-widest text-[10px] mb-2 group-hover/email:text-[var(--brand-neutral)] transition-colors">
                                                {t("footer.supportEmail")}
                                            </p>
                                            <p className="text-[var(--brand-dark)] font-black text-xl hover:text-[var(--brand-blue)] transition-colors">
                                                {t("dataDeletion.section5.email")}
                                            </p>
                                        </div>
                                        <p className="text-xs font-bold italic text-[var(--brand-neutral)] text-center px-4 leading-relaxed">
